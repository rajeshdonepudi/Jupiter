...
interface ViewSelectedSecurityGroupsProps {
  securityGroupIds: string[];
  isReviewPage?: boolean;
}
const ViewSelectedSecurityGroups = (props: ViewSelectedSecurityGroupsProps) => {
  ...
  useEffect(() => {
    if (props.securityGroupIds) {
      debouncedGetTenantDetails(props.securityGroupIds); // Use memoized debounced function
    }
  }, [props.securityGroupIds, debouncedGetTenantDetails]);
    ...
    >
      {isLoading ? (
        ...
        <AppPaper>
          ...
          >
            <Typography variant="h5">No Security Groups Selected.</Typography>
          </Stack>
        </AppPaper>
      )}
    </Grid>
...
export default ViewSelectedSecurityGroups;
