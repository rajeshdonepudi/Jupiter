        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceAlias = table.Column<string>(type: "nvarchar(max)", nullable: false, computedColumnSql: "CONVERT(NVARCHAR(max), 20251025185358038) + '-FALO_USR' + CAST([ResourceId] AS NVARCHAR(max))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountAlias = table.Column<string>(type: "nvarchar(max)", nullable: false, computedColumnSql: "CONVERT(NVARCHAR(max), 20251025185358038) + '-FALO_TEN' + CAST([AccountId] AS NVARCHAR(max))"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeadStatuses_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeadStatuses_AspNetUsers_DeletedByUserId",
                        column: x => x.DeletedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeadStatuses_AspNetUsers_LastUpdatedByUserId",
                        column: x => x.LastUpdatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leads_AspNetUsers_DeletedByUserId",
                        column: x => x.DeletedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leads_AspNetUsers_LastUpdatedByUserId",
                        column: x => x.LastUpdatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_DeletedByUserId",
                table: "Leads",
                column: "DeletedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Leads_LastUpdatedByUserId",
                table: "Leads",
                column: "LastUpdatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadStatuses_CreatedByUserId",
                table: "LeadStatuses",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadStatuses_DeletedByUserId",
                table: "LeadStatuses",
                column: "DeletedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadStatuses_LastUpdatedByUserId",
                table: "LeadStatuses",
                column: "LastUpdatedByUserId");
